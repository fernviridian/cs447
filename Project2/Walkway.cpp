/*
 * Walkway.cpp: A class for drawing the ground.
 *
...
Walkway::Initialize(void)
{
    ...
    if ( ! ( image_data = (ubyte*)tga_load("./walkway.tga", &image_width,
					   &image_height, TGA_TRUECOLOR_24) ) )
    {
	fprintf(stderr, "Walkway::Initialize: Couldn't load grass.tga\n");
	return false;
    }
